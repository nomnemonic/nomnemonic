...
func TestGenerate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			password:   "test1234",
			passcode:   "101938",
			sentence:   "win error husband trend bag neck divorce jewel waste swear state trial sadness coral ridge cement visit tip tunnel bitter jelly pudding upgrade scorpion",
		},
		{
			size:       21,
			identifier: "mnemonicer_test",
			password:   "test1234",
			passcode:   "101938",
			sentence:   "tool barely talent alarm gentle gadget april must mesh crisp silent fever elbow when length pioneer useless because cram winner hole",
		},
		{
			size:       18,
			identifier: "mnemonicer_test",
			password:   "test1234",
			passcode:   "101938",
			sentence:   "result between pottery fork until pill define prepare tube enemy weird couch clinic dinner brisk table erode isolate",
		},
		{
			size:       15,
			identifier: "mnemonicer_test",
			password:   "test1234",
			passcode:   "101938",
			sentence:   "snake another foot minimum soup depend goddess same cruise warrior give enough inject never ketchup",
		},
		{
			size:       12,
			identifier: "mnemonicer_test",
			password:   "test1234",
			passcode:   "101938",
			sentence:   "produce moment army rural toward wrestle raccoon art mistake write agent ocean",
		},
		{
			size:       12,
			identifier: "te",         // min size identifier
			password:   "paSZW0rD!.", // any size password
			passcode:   "101938",     // 6 digit passcode
			sentence:   "sense ramp remind hunt safe now clever pact outer prison drive diagram",
		},
		// validations
		{
			size:       11,
		...
		},
		{
			...
			password:   "",
			passcode:   "101938",
			err:        errors.New("password must be at least 8 chars"),
		},
		{
			size:       12,
			identifier: "te",
